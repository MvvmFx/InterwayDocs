...
{
    public partial class IncomingBookView : BookViewBase, IHaveDataContext
    {
        ...
        public object DataContext
        {
            ...
            set
            {
                var viewModel = value as IncomingBookViewModel;
                if (viewModel != null)
                {
                    IsNotifying = true;
        ...
        private void BindOnce()
        {
            ...
            bindingDisplayName.TargetObject = panelTitle;
        ...
        private void SetConfiguration()
        {
            ...
            if (iHaveConfigurationList != null)
            {
                ...
                Helper.SetElementConfiguration(senderNameDataGridViewTextBoxColumn, configurationList);
                Helper.SetElementConfiguration(receptionDateDataGridViewTextBoxColumn, configurationList);
                Helper.SetElementConfiguration(routedToDataGridViewTextBoxColumn, configurationList);
            }
        }
