/****** Object:  View [dbo].[OutgoingView]    Script Date: 01/19/2016 11:59:18 ******/
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[OutgoingView]'))
DROP VIEW [dbo].[OutgoingView]
GO

/****** Object:  View [dbo].[OutgoingView]    Script Date: 01/22/2016 15:33:53 ******/
SET ANSI_NULLS ON
GO
