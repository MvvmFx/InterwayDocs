/****** Object:  View [dbo].[DeliveryView]    Script Date: 01/19/2016 11:58:56 ******/
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[DeliveryView]'))
DROP VIEW [dbo].[DeliveryView]
GO

/****** Object:  View [dbo].[DeliveryView]    Script Date: 01/22/2016 15:33:33 ******/
SET ANSI_NULLS ON
GO
