/****** Object:  View [dbo].[IncomingView]    Script Date: 01/19/2016 11:59:06 ******/
IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[IncomingView]'))
DROP VIEW [dbo].[IncomingView]
GO

/****** Object:  View [dbo].[IncomingView]    Script Date: 01/22/2016 15:33:42 ******/
SET ANSI_NULLS ON
GO
