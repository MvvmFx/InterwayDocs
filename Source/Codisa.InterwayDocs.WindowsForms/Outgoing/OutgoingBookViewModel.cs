...
{
    public class OutgoingBookViewModel : ConductorWithModel<OutgoingDetailViewModel, OutgoingBook>,
        IBookViewModel, IHaveConfigurationList
    {
        ...
        private static PropertyConfigurationList _configurationList
        {
            get { return ApplicationBase.Session.Codisa_InterwayDocs_OutgoingBookViewModel_ConfigurationList; }
            set { ApplicationBase.Session.Codisa_InterwayDocs_OutgoingBookViewModel_ConfigurationList = value; }
        }
#endif
        ...
        private OutgoingBookCriteriaGet _refreshCriteria;
        ...
        public PropertyConfigurationList ConfigurationList
        {
            get
            {
                if (_configurationList == null)
                    _configurationList = PropertyConfigurationList.GetPropertyConfigurationList("OutgoingInfo",
        ...
        public int ListItemId
        {
            ...
            set
            {
                ...
                _listItemId = value;
                if (_listItemId > 0)
                    ActivateItem(new OutgoingDetailViewModel(_listItemId));
        ...
        protected override void OnModelChanged(OutgoingBook oldValue, OutgoingBook newValue)
        {
            if (oldValue != null)
        ...
        protected override void OnRefreshing(OutgoingBook model)
        {
            if (model != null)
        ...
        protected override void OnViewAttached(object view, object context)
        {
            ...
            DisplayName = "OutgoingBookDisplayName".GetUiTranslation();
            ResetHeaderMessage();
        ...
        {
            Criteria = new OutgoingBookCriteriaGet();
        ...
        private void StoreRefreshData()
        {
            ...
            _refreshCriteria = new OutgoingBookCriteriaGet();
            var criteria = Criteria as OutgoingBookCriteriaGet;
            if (criteria != null)
            {
        ...
        {
            ListItemId = -1;
            ActivateItem(new OutgoingDetailViewModel(doCreate));
        }
        ...
        public void PrintList()
        {
            PrintBook.DoPrintBook(this, ConfigurationList, _refreshCriteria, _refreshDateTime,
                6, "OutgoingBookShortName".GetUiTranslation(), "OutgoingBookDisplayName".GetUiTranslation());
        }
