...
namespace Codisa.InterwayDocs.Outgoing
{
    public class OutgoingDetailViewModel : ScreenWithModel<OutgoingRegister>, IDetailViewModel, IHaveConfigurationList
    {
        ...
        {
            PrintRecord.DoPrintRecord(this, _refreshDateTime, 4, "OutgoingRegisterShortName".GetUiTranslation(),
                "OutgoingRegisterReportName".GetUiTranslation(), Model.RegisterId);
        }
