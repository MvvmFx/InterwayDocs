...
{
    public class DeliveryBookViewModel : ConductorWithModel<DeliveryDetailViewModel, DeliveryBook>,
        IBookViewModel, IHaveConfigurationList
    {
        ...
        private static PropertyConfigurationList _configurationList
        {
            get { return ApplicationBase.Session.Codisa_InterwayDocs_DeliveryBookViewModel_ConfigurationList; }
            set { ApplicationBase.Session.Codisa_InterwayDocs_DeliveryBookViewModel_ConfigurationList = value; }
        }
#endif
        ...
        private DeliveryBookCriteriaGet _refreshCriteria;
        ...
        public PropertyConfigurationList ConfigurationList
        {
            get
            {
                if (_configurationList == null)
                    _configurationList = PropertyConfigurationList.GetPropertyConfigurationList("DeliveryInfo",
        ...
        public int ListItemId
        {
            ...
            set
            {
                ...
                _listItemId = value;
                if (_listItemId > 0)
                    ActivateItem(new DeliveryDetailViewModel(_listItemId));
        ...
        protected override void OnModelChanged(DeliveryBook oldValue, DeliveryBook newValue)
        {
            if (oldValue != null)
        ...
        protected override void OnRefreshing(DeliveryBook model)
        {
            if (model != null)
        ...
        {
            Criteria = new DeliveryBookCriteriaGet();
        ...
        private void StoreRefreshData()
        {
            ...
            _refreshCriteria = new DeliveryBookCriteriaGet();
            var criteria = Criteria as DeliveryBookCriteriaGet;
            if (criteria != null)
            {
        ...
        {
            ListItemId = -1;
            ActivateItem(new DeliveryDetailViewModel(doCreate));
        }
