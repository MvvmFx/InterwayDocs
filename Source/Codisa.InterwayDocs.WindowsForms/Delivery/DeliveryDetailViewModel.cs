...
{
    public class DeliveryDetailViewModel : ScreenWithModel<DeliveryRegister>, IDetailViewModel, IHaveConfigurationList
    {
        #region Fields
        ...
        private static PropertyConfigurationList _configurationList
        {
            get { return ApplicationBase.Session.Codisa_InterwayDocs_DeliveryDetailViewModel_ConfigurationList; }
            set { ApplicationBase.Session.Codisa_InterwayDocs_DeliveryDetailViewModel_ConfigurationList = value; }
        }
#endif
        ...
        private DeliveryBookViewModel _parent;
        ...
        public PropertyConfigurationList ConfigurationList
        {
            get
            {
                if (_configurationList == null)
                    _configurationList = PropertyConfigurationList.GetPropertyConfigurationList("DeliveryRegister",
        ...
        private DeliveryDetailViewModel()
        {
            // force to use parametrized constructor
        }

        public DeliveryDetailViewModel(bool createDocument) :
            this()
        {
        ...
        public DeliveryDetailViewModel(int registerId) :
            this()
        {
        ...
        private void OnPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == "Parent")
            {
                ...
                _parent = Parent as DeliveryBookViewModel;
                if (_parent != null)
                {
                    if (_registerId > 0)
        ...
        private void LoadModel()
        {
            if (_isCreating)
            {
                DoRefresh(DeliveryRegister.NewDeliveryRegister);
            ...
            {
                DoRefresh(() => DeliveryRegister.GetDeliveryRegister(_registerId));
        ...
        {
            PrintRecord.DoPrintRecord(this, _refreshDateTime, 4, Resources.DeliveryRegisterReportName,
                Resources.DeliveryRegisterReportName, Model.RegisterId);
        }
