...
{
    /// <summary>
    /// RestoreDatabase Command.<br/>
    /// </summary>
    [Serializable]
    public class RestoreDatabase : CommandBase<RestoreDatabase>
    {
        #region Constants
        ...
        public static RestoreDatabase DoRestore(string fullPathFilename)
        {
            RestoreDatabase cmd = new RestoreDatabase { FullPathFilename = fullPathFilename };
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RestoreDatabase"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Loads a <see cref="RestoreDatabase"/> object from the database, based on given criteria.
        /// </summary>
        protected override void DataPortal_Execute()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager(Database.InterwayDocsConnection, false))
            {
                using (var cmd = new SqlCommand(RestoreQuery, ctx.Connection))
                {
