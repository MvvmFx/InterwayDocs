...
namespace Codisa.InterwayDocs.Business
{
    ...
    public partial class OutgoingRegister : EditOnDemandBase<OutgoingRegister>, IHaveAudit
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<SmartDate> SendDateProperty = RegisterProperty<SmartDate>(p => p.SendDate, "Sent date");
        /// <summary>
        ...
        protected override void AddBusinessRules()
        {
            ...
            // SendDate
            BusinessRules.AddRule(new DateNotInFuture(SendDateProperty) { MessageDelegate = () => "DateNotInFuture".GetTranslation(), Priority = 1 });
            // RecipientName
