...
namespace Codisa.InterwayDocs.Business
{
    public partial class DeliveryBook
    {
        ...
        private const string QueryList =
            "DeliveryRegisters.RegisterId, RegisterDate, DocumentType, DocumentReference, DocumentEntity, DocumentDept, DocumentClass, DocumentDate, RecipientName, ExpeditorName, ReceptionName, ReceptionDate";
        ...
        partial void OnFetchPre(DataPortalHookArgs args)
        {
            ...
            var crit = args.CriteriaArg as DeliveryBookCriteriaGet;
